...
<section id="<?php echo esc_attr($id); ?>" class="module <?php echo esc_attr($classes); ?>">
  ...
  <div class="container">
    <?php $headline_2 = get_field('sektions-uberschrift'); ?>
    <?php if ($headline_2): ?>

      <h2 class="headline headline-2">
        <?= wp_kses_post($headline_2) ?>
      </h2>
    <?php endif; ?>
    <div class="ansprechpartner group wrapper">
      <?php if (have_rows('ansprechpartner_group')) : ?>
        <?php while (have_rows('ansprechpartner_group')) : the_row(); ?>

          <?php if (have_rows('ansprechpartner_single')) : ?>

            <?php while (have_rows('ansprechpartner_single')) : the_row(); ?>

              <!-- <div class="ansprechpartner__blur" aria-hidden="true"></div> -->


              <div class="ansprechpartner__overlay">
                <?php
                $headline_3 = get_sub_field('headline_3');
                $subheadline = get_sub_field('subheadline');
                $ansprechpartner_button = get_sub_field('button');
