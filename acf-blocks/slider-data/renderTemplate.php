...
$classes = 'image-data slider-data';
...
<section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($classes); ?>">
  <div class="container">
    ...
    <?php $id_slider = get_field('id::slider'); ?>

    <div class="slider-data image-data__col image-data__col--image">
      <?php if ($id_slider): ?>
        <?php echo do_shortcode('[tp_slider id="' . esc_attr($id_slider) . '"]'); ?>
      <?php endif; ?>
    </div>
